    ...
    <View style={styles.WorkshopListScreenCard}>
      <View style={styles.WorkshopListScreenCardInner}>
        <View style={styles.WorkshopListScreenCardBody}>
          ...
          <Text
            style={styles.WorkshopListScreenCardDescription}
            numberOfLines={2}>
            {text.description}
          </Text>
          <Text style={styles.WorkshopListScreenCardWordCount}>
        ...
        ListHeaderComponent={
          <>
            ...
            <View style={styles.WorkshopListScreenHeaderRow}>
              ...
              <Pressable
                onPress={onNew}
                style={styles.WorkshopListScreenNewButtonWrapper}>
                <LinearGradient
                  colors={[
                  ...
                  <Text style={styles.WorkshopListScreenNewButtonText}>
                    New
                  </Text>
                </LinearGradient>
              </Pressable>
