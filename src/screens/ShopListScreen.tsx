...
export function ShopListScreen({
        ...
        <View style={styles.ShopListScreenCardBody}>
          <View style={styles.ShopListScreenCardTopRow}>
            <View style={styles.ShopListScreenCardTextBlock}>
              <Text style={styles.ShopListScreenCardTitle}>{text.title}</Text>
            ...
            <View
              ...
              <Image source={!owned ? icons.lock : icons.unlocked} />
            </View>
          </View>
  ...
  return (
    <AppBackground>
          ...
          <>
            ...
            <View style={styles.ShopListScreenHeaderRow}>
              ...
              <View style={styles.ShopListScreenBalanceBadge}>
                ...
                <Text style={styles.ShopListScreenBalanceValue}>{balance}</Text>
              </View>
            </View>
      ...
      {toastMessage ? (
        <View
          style={[styles.ShopListScreenToast, {bottom: insets.bottom + 90}]}>
          <Text style={styles.ShopListScreenToastText}>{toastMessage}</Text>
        </View>
      ) : null}
    </AppBackground>
  );
