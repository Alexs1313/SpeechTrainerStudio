...
export function PrompterConfigureScreen({text, onBack, onBegin}: Props) {
  ...
  const [speedQuantity, setSpeedQuantity] = useState<TextSpeed>('medium');
      ...
      <ScrollView
        ...
        <View style={styles.PrompterConfigureScreenSummaryCard}>
          <View style={styles.PrompterConfigureScreenSummaryMeta}>
            <Text style={styles.PrompterConfigureScreenSummaryEmoji}>
              {category.emoji}
            </Text>
          ...
          <Text style={styles.PrompterConfigureScreenSummaryDescription}>
            {text.description}
          </Text>
        </View>
        ...
        <View style={styles.PrompterConfigureScreenTipCard}>
          <Text style={styles.PrompterConfigureScreenTipText}>
            <Text style={styles.PrompterConfigureScreenTipLabel}>
              💡 Coach Marcus:{' '}
            </Text>
        ...
        <Pressable
          onPress={() => onBegin({text, speed: speedQuantity, size})}
          ...
          <LinearGradient
            ...
            <Text style={styles.PrompterConfigureScreenBeginText}>
              Begin Session
            </Text>
          </LinearGradient>
        </Pressable>
    ...
    <View style={styles.PrompterConfigureScreenSettingCard}>
      <View style={styles.PrompterConfigureScreenSettingHeader}>
        <View style={styles.PrompterConfigureScreenSettingLabelRow}>
          ...
          <Text style={styles.PrompterConfigureScreenSettingLabel}>
            {label}
          </Text>
        </View>
        <View style={styles.PrompterConfigureScreenValuePill}>
          <Text style={styles.PrompterConfigureScreenValuePillText}>
            {value}
          </Text>
        </View>
      </View>
