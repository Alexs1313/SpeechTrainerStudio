  ...
  return (
    <AppBackground>
      <ScrollView
        ...
        <Text style={styles.PrompterChooseScreenEyebrow}>
        ...
        <LinearGradient
          ...
          <View
            ...
            <Text style={styles.PrompterChooseScreenCoachText}>
              <Text style={styles.PrompterChooseScreenCoachBold}>
                Coach Marcus says:{' '}
              </Text>
        ...
        <Text style={styles.PrompterChooseScreenSectionTitle}>
          Select Category
        </Text>
                ...
                {active ? (
                  <LinearGradient
                    ...
                    style={[
                      ...
                      styles.PrompterChooseScreenCategoryCardActive,
                    ]}>
                    <View
                      style={{
                        padding: 15,
          ...
          {availableTexts.map(item => (
            <Pressable
              ...
              <View style={styles.PrompterChooseScreenTextCardBody}>
                <Text style={styles.PrompterChooseScreenTextTitle}>
                  {item.title}
                </Text>
                <Text style={styles.PrompterChooseScreenTextDescription}>
                  {item.description}
                </Text>
                <Text style={styles.PrompterChooseScreenWordCount}>
  ...
  return (
    <>
      <View style={styles.PrompterChooseScreenCategoryIcon}>
        <Text style={styles.PrompterChooseScreenCategoryEmoji}>
          {category.emoji}
        </Text>
      </View>
      <View style={styles.PrompterChooseScreenCategoryInfo}>
        <Text style={styles.PrompterChooseScreenCategoryTitle}>
          {category.title}
        </Text>
