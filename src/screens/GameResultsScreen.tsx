...
import {formatGameTime} from '../utils/gameEvaluation';
    ...
    <AppBackground>
      <ScrollView
        ...
        <View style={styles.GameResultsScreenHeader}>
          <Pressable
            onPress={onBack}
            style={styles.GameResultsScreenBackButton}
            hitSlop={8}>
        ...
        <View style={styles.GameResultsScreenHeroCard}>
          <LinearGradient
            ...
            style={[
              ...
              isGood
                ? styles.GameResultsScreenHeroGood
                : styles.GameResultsScreenHeroBad,
            ]}>
            <View style={styles.GameResultsScreenHeroInner}>
              <Text style={styles.GameResultsScreenHeroEmoji}>
                {isGood ? '🏆' : '😤'}
              </Text>
              <Text
                style={[
                  styles.GameResultsScreenHeroTitle,
                  isGood
                    ? styles.GameResultsScreenGoodText
                    : styles.GameResultsScreenBadText,
                ]}>
              ...
              {isGood && (
                <View style={styles.GameResultsScreenRewardBadge}>
                  ...
                  <Text style={styles.GameResultsScreenRewardText}>
                    +3 Microphones earned!
                  </Text>
                </View>
              )}
            </View>
        ...
        <View style={styles.GameResultsScreenTopicCard}>
          <View style={styles.GameResultsScreenTopicInner}>
            ...
            <Text style={styles.GameResultsScreenTopicText}>
              {result.topic}
            </Text>
          </View>
        </View>
          ...
          <LinearGradient
            ...
            <View style={styles.GameResultsScreenFeedbackInner}>
              <View style={styles.GameResultsScreenFeedbackHeader}>
                ...
                <Text style={styles.GameResultsScreenFeedbackName}>
                  Coach Marcus
                </Text>
              </View>
              <Text style={styles.GameResultsScreenFeedbackText}>
