...
import {BLOG_AUTHOR} from '../constants/blogArticles';
      ...
      <ScrollView
        ...
        <View style={styles.BlogArticleScreenHero}>
          ...
          <Pressable
            onPress={onBack}
            style={[
              styles.BlogArticleScreenBackButton,
              {top: insets.top + 12},
            ]}>
        ...
        <View style={styles.BlogArticleScreenBody}>
          <View style={styles.BlogArticleScreenMetaRow}>
            <View style={styles.BlogArticleScreenCategoryPill}>
              <Text style={styles.BlogArticleScreenCategoryText}>
                {article.category}
              </Text>
            </View>
          ...
          <View style={styles.BlogArticleScreenParagraphs}>
            {article.paragraphs.map((paragraph, index) => (
              <Text
                ...
                style={[
                  styles.BlogArticleScreenParagraph,
                  index > 0 && styles.BlogArticleScreenParagraphGap,
                ]}>
                {paragraph}
              </Text>
            ))}
